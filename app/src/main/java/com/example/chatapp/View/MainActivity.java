...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuery = mFireStore.collection("Mesaj İstekleri").document(mUser.getUid()).collection("İstekler");
    ...
    private void mesajIstekleriDialog() {
        ...
        if (mesajIstegiList.size() > 0) {
            mAdapter = new MesajIstekleriAdapter(mesajIstegiList, this, mKullanici.getKullaniciId(), mKullanici.getKullaniciIsim(), mKullanici.getKullaniciProfil());
