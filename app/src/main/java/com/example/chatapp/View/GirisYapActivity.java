...
public class GirisYapActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        inputEmail = (TextInputLayout) findViewById(R.id.girisYap_inputEmail);
        inputSifre = (TextInputLayout) findViewById(R.id.girisYap_inputSifre);

        editEmail = (EditText) findViewById(R.id.girisYap_editEmail);
        editSifre = (EditText) findViewById(R.id.girisYap_editSifre);
    }
