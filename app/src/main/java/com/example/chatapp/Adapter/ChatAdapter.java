...
//        holder.imgGoruldu.setImageResource(R.drawable.ic_goruldu);
        ...
        holder.imgResim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != RecyclerView.NO_POSITION && listener != null) {
                    listener.onResimClick(position);
                }
            }
        });
    ...
    public interface OnResimClickListener {
        void onResimClick(int position);
    }

    private OnResimClickListener listener;

    public void setOnResimClickListener(OnResimClickListener listener) {
...
//            imgGoruldu = itemView.findViewById(R.id.chat_item_imgGoruldu);
        }
    }
